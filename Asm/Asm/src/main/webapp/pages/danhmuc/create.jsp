...
<div class="container">
    ...
    <form action="/danhMuc/store" method="post" >
        <div class="mb-3">
            <label class="form-label">Mã Danh Mục:</label>
            <input type="text" class="form-control" id="maSanPham" name="maDanhMuc">
        </div>
        <div class="mb-3">
            <label class="form-label">Tên Danh Mục:</label>
            <input type="text" class="form-control" id="tenSanPham" name="tenDanhMuc">
        </div>
        <div class="mb-3">
