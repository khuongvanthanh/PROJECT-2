...
<body>
<div class="container">
    <h2 class="text-center">Thêm Size</h2>
    <form action="/size/store" method="post" >
        <div class="mb-3">
            <label class="form-label">Mã Size:</label>
            <input type="text" class="form-control" id="maSanPham" name="maSize">
        </div>
        <div class="mb-3">
            <label class="form-label">Tên Size:</label>
            <input type="text" class="form-control" id="tenSanPham" name="tenSize">
        </div>
        <div class="mb-3">
